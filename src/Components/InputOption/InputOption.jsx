...
export default class InputOption extends Component {
    ...
    handleDeletePost = async() => {
        ...
        const response = await this.fetchApi(body, this.props.baseUrl, 'posts', 'DELETE');
    ...
    render() {
        ...
        return (
            <div className="inputOption">
                {upload && <input ref={this.inputRef} type="file" accept="image/*" value={this.state.value} onClick={e => {if(e.target.value) this.setState({value: ''})}} onChange={this.handleImage} hidden/>}
